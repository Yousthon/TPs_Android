...
public class EditMarkerINFO extends AppCompatActivity {
    ...
    //On traite l'image sélectionnée ou capturée en fonction de l'action de l'user
    @Override
    ...
    //Methode permettant d'afficher l'image capturée ou sélectionner sur l'interface
    ...
    //Validation une fois edition d'infos terminée
    public void saveMarker(View view) {
        ...
        //On fait rien si aucun élément renseigné
        if ((titre == null || titre.isEmpty()) && !PhotoSelected)
            ...
            //Nom par défaut si pas de nom renseigné
            if ((titre == null || titre.isEmpty()))
                titre = getString(R.string.Marker_nom_parDefaut);

            //Envoi des données avec le code RESULT_OK
